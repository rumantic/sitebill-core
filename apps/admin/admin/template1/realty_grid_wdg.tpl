                    ...
                    <tr valign="top" class="{if $grid_items[i].hot.value}row3hot{/if}{if intval($grid_items[i].status_id.value)>0} row_status_id{$grid_items[i].status_id.value}{/if}{if $grid_items[i].active.value == 0} notactive{/if}{if intval($grid_items[i].archived.value) === 1} archived{/if}{if $grid_items[i]._classes ne ''} {$grid_items[i]._classes}{/if}">
                        ...
                        {if $admin_grid_leftbuttons==1}
                            <td nowrap>
                                ...
                                <a href="{$estate_folder_control}?action=data&do=edit&id={$grid_items[i].id.value}" class="btn btn-info {if isset($grid_items[i].status_id)}btn-mini{/if}"><i class="icon-white icon-pencil"></i></a>
                                {if intval($grid_items[i].archived.value) === 1}
                                <a onclick="return confirm('{$L_MESSAGE_REALLY_WANT_DELETE}');" href="{$estate_folder_control}?action=data&do=delete_final&id={$grid_items[i].id.value}" class="btn btn-danger {if isset($grid_items[i].status_id)}btn-mini{/if}"><i class="icon-white icon-remove"></i></a>
                                {else}
                                <a onclick="return confirm('{$L_MESSAGE_REALLY_WANT_DELETE}');" href="{$estate_folder_control}?action=data&{if $topic_id != ''}topic_id={$topic_id}&{/if}do=delete&id={$grid_items[i].id.value}" class="btn btn-danger {if isset($grid_items[i].status_id)}btn-mini{/if}"><i class="icon-white icon-remove"></i></a>
                                {/if}
                            ...
                            {if $admin !=''}
                                <td nowrap>
                                    <button data-id="{$grid_items[i].id.value}" class="fast_preview btn btn-danger btn-mini"><i class="icon-white icon-eye-open"></i></button>
                                        ...
                                        <a href="{$estate_folder_control}?action=data&do=edit&id={$grid_items[i].id.value}" class="btn btn-info btn-mini"><i class="icon-white icon-pencil"></i></a>
                                            {if intval($grid_items[i].archived.value)==1}
                                            <a onclick="return confirm('{$L_MESSAGE_REALLY_WANT_DELETE}');" href="{$estate_folder_control}?action=data&do=delete_final&id={$grid_items[i].id.value}" class="btn btn-danger btn-mini"><i class="icon-white icon-remove"></i></a>
                                            <a href="{$estate_folder_control}?action=data&do=restore&id={$grid_items[i].id.value}" class="btn btn-success btn-mini"><i class="icon-white icon-ok"></i></a>
                                            {else}
                                            <a onclick="return confirm('{$L_MESSAGE_REALLY_WANT_DELETE}');" href="{$estate_folder_control}?action=data&{if $topic_id != ''}topic_id={$topic_id}&{/if}do=delete&id={$grid_items[i].id.value}" class="btn btn-danger btn-mini"><i class="icon-white icon-remove"></i></a>
                                            {/if}
